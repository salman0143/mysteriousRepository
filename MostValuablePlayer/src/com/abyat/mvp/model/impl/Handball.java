...
public class Handball implements Sport<HandballPlayerMatchStats> {
	...
	@Override
	public int calculatePlayerRaiting(HandballPlayerMatchStats playerMatchStats) {
		...
		Map<HandballAction, Integer> actions = playerMatchStats.getPlayerActions();
	...
	@Override
	public int calculateTeamScore(String teamName, List<HandballPlayerMatchStats> playerMatchStatsList) {

		int teamScore = 0;

		for (HandballPlayerMatchStats playerMatchStats : playerMatchStatsList) {
			...
			teamScore += playerMatchStats.getPlayerActions().get(HandballAction.GOAL_MADE);
		}
