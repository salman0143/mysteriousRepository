...
public class MVPUtil {
	 ...
	 * @throws Exception
	 */
	public static String getMVPNick(List<PlayerMatchStats> playerMatchStatsList) throws Exception {
		...
		for (PlayerMatchStats playerMatchStats : playerMatchStatsList) {
			int rating = playerRatings.getOrDefault(playerMatchStats.getPlayerNick(), 0);
